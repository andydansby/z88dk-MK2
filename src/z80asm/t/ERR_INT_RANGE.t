...
# $Header: /cvsroot/z88dk/z88dk/src/z80asm/t/ERR_INT_RANGE.t,v 1.2 2012/05/26 18:51:10 pauloscustodio Exp $
...
for ([0x00 => 0xC7], [0x08 => 0xCF], [0x10 => 0xD7], [0x18 => 0xDF], 
    ...
    my($rst, $opcode) = @$_;
    t_z80asm_error("rst ".($rst-1), "Error at file 'test.asm' line 1: Integer '".($rst-1)."' out of range");
    t_z80asm_ok(0, "rst $rst", chr($opcode));
    t_z80asm_error("rst ".($rst+1), "Error at file 'test.asm' line 1: Integer '".($rst+1)."' out of range");
}

# bit out of range
t_z80asm_error("bit -1,a", 	"Error at file 'test.asm' line 1: Integer '-1' out of range");
t_z80asm_ok(0, "bit 0,a",	"\xCB\x47");
t_z80asm_ok(0, "bit 7,a",	"\xCB\x7F");
t_z80asm_error("bit 8,a", 	"Error at file 'test.asm' line 1: Integer '8' out of range");
...
t_z80asm_error("
	...
	", "Error at file 'test.asm' line 4: Integer '0' out of range");
t_z80asm_error("
	defvars 0
	{
	    s1  ds.b 65537
	}
	", "Error at file 'test.asm' line 4: Integer '65537' out of range");

# defs out of range
t_z80asm_error("defs -1", 	"Error at file 'test.asm' line 1: Integer '-1' out of range");
...
t_z80asm_error("defs 65537", 	"Error at file 'test.asm' line 1: Max. code size of 65536 bytes reached");

# org out of range
t_z80asm_error("org -1", 	"Error at file 'test.asm' line 1: Integer '-1' out of range");
t_z80asm_ok(0, "org 0",		"");
t_z80asm_ok(0, "org 65534",	"");
# t_z80asm_ok(0, "org 65535",	""); # NOTE: 0xFFFF is used as a marker for ORG not defined
t_z80asm_error("org 65536", 	"Error at file 'test.asm' line 1: Integer '65536' out of range");
...
t_z80asm_error("jr asmpc+2+128", "Error at file 'test.asm' line 1: Integer '128' out of range");

# DJNZ
t_z80asm_error("djnz asmpc+2-129", "Error at file 'test.asm' line 1: Integer '-129' out of range");
t_z80asm_ok(100, "djnz asmpc+2-128", "\x10\x80");
t_z80asm_ok(100, "djnz asmpc+2+127", "\x10\x7F");
t_z80asm_error("djnz asmpc+2+128", "Error at file 'test.asm' line 1: Integer '128' out of range");
...
t_z80asm_error("jr label \n defc label = asmpc+128", 
		"Error at file 'test.asm' module 'TEST' line 1: Integer '128' out of range");
